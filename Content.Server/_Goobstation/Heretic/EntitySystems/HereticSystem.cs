...
public sealed partial class HereticSystem : EntitySystem
{
    ...
    private void OnRerollTargets(Entity<HereticComponent> ent, ref EventHereticRerollTargets args)
    {
        ...
        predicates.Add(t =>
            ...
            && _jobs.MindTryGetJob(mindid, out var jobc) && jobc.Prototype.HasValue // does it have a job?
        ...
        predicates.Add(t =>
            ...
            && _jobs.MindTryGetJob(tmind, out var tjob) && tjob.Prototype.HasValue // get jobs
            && _jobs.MindTryGetJob(ownmind, out var ownjob) && ownjob.Prototype.HasValue
